...
fn find_char(buf: &super::super::buffer::Buffer, start: usize, ch: char, count: usize) -> Option<usize> {
    assert!(count > 0);
    buf.chars()
        .enumerate()
        .skip(start)
...
fn find_char_rev(buf: &super::super::buffer::Buffer, start: usize, ch: char, count: usize) -> Option<usize> {
    assert!(count > 0);
